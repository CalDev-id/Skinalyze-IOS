...
struct ChatView: View {
    init() {
        ...
        appearance.backgroundColor = UIColor.greenBase // Warna background navigasi
        ...
        VStack {
            ScrollView {
                VStack(alignment: .leading, spacing: 10) {
                        ...
                        HStack {
                            if message.role == .system {
                                ...
                                Text(message.text)
                                    ...
                                    .shadow(color: Color.black.opacity(0.2), radius: 10, x: 0, y: 5) // Outline shadow
                    ...
                    if showLoading {
                        TypingIndicator() // Animasi tiga titik loading
                            .frame(maxWidth: .infinity, alignment: .leading)
                            .padding(.top, 10)
                    }
                }
            ...
            if currentQuestionIndex == 2, showOptions { // Gender
                VStack(spacing: 10) {
                    Button(action: {
